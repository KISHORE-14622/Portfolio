        ...
        <div ref={ref} className="timeline relative w-full">
          ...
          {experiences.map((exp, index) => (
            <motion.div
              ...
              className={`timeline-item relative bg-inherit w-full md:w-1/2 mb-8 ${exp.side === 'left'
                ? 'md:left-0 md:pr-8'
                : 'md:left-1/2 md:pl-8'
                }`}
            >
              {/* Timeline Dot */}
              <div className={`timeline-dot absolute w-4 h-4 top-12 bg-gray-200 border-2 border-purple-600 rounded-full z-10 ${exp.side === 'left'
                ? 'md:-right-2 left-0 md:left-auto'
                : 'md:-left-2 left-0'
                }`}></div>

              {/* Timeline Arrow */}
              <div className={`absolute top-11 z-10 ${exp.side === 'left'
              ...
              {/* Date */}
              <div className={`timeline-date absolute w-full top-11 text-base font-semibold text-purple-400 uppercase tracking-wider z-10 ${exp.side === 'left'
              ...
              {/* Content */}
              <div className={`timeline-text p-8 bg-white relative shadow-lg ${exp.side === 'left'
